<template>
    ...
    <div>
        <div
            class="bg-gradient-to-r from-[#393E46] via-[#FFD369] to-[#EEEEEE] p-3"
        >
            <div
            ...
            >
                <img
                    src="/logofix.png"
                    class="w-20 shadow border-2 border-[#393e46] rounded-full place-self-center animate-pulse"
                />

                <h1 class="text-black place-self-center text-xl font-bold mt-2">
                    TERATAI FURNITURE
                </h1>
                ...
                <div class="container text-center mt-5">
                    <div v-for="(p, i) in linker" :key="i">
                        <a
                            :href="'/rdr/' + p.label + '?ref=iaproperty-web'"
                            target="_blank"
                        >
                            <div
                ...
                <div class="flex flex-row gap-2 justify-center">
                    <a
                        href=""
                        class="bg-blue-500 hover:bg-blue-700 rounded p-3 text-lg text-white"
                        ><i class="mdi mdi-facebook"></i
                    ></a>
                    <a
                        href=""
                        class="bg-black hover:bg-gray-600 rounded p-3 text-lg text-white"
                        ><i class="mdi mdi-twitter"></i
                    ></a>
                    <a
                        href=""
                        class="bg-green-500 hover:bg-green-700 rounded p-3 text-lg text-white"
                        ><i class="mdi mdi-whatsapp"></i
                    ></a>
                    <a
                        href=""
                        class="bg-yellow-500 hover:bg-yellow-300 rounded p-3 text-lg text-white"
                        ><i class="mdi mdi-link"></i
                    ></a>
                </div>
                <div class="text-center bottom-0 absolute mt-5">
                    &copy; {{ new Date().getFullYear() }} Teratai Furniture.
                </div>
            </div>
        </div>
    </div>
